...
subroutine sub_denoise_TV(n1,n2,n3,epsilon,delta,epsilon_noise,x_ns,x_dns,iter_max,xwater)
  ...
  !LOCAL VARIABLES
  integer :: i1,i2,i3,cpt_iter,cpt_print,iter_max
  real :: mu,Lmu,Dijkx1,Dijkx2,Dijkx3,norm_Dijkx,norm_temp,norm_w,den,Ak,alpha,tk
  real :: uijk1,uijk2,uijk3,epsilon_true,R,epsilon_noise,xwater
  logical :: convergence_test,convergence_prev
...
!     close(60)
     ...
     convergence_test=((cpt_iter.ge.iter_max) .or. (abs(gap-gap_prev) .lt. xwater) ) .and. convergence_prev

     convergence_prev=(cpt_iter.ge.iter_max) .or. (abs(gap-gap_prev) .lt. xwater)     
     gap_prev=gap
...
!=====================================================================
subroutine nesterov(x_ns,x_dns,n1,n2,n3,epsilon,delta,epsilon_noise,iter_max,xwater)
  implicit none
  ...
  real,dimension(n1,n2,n3) :: x_dns
  !Precision
  real :: epsilon,delta,epsilon_noise,norm_inf_xns,min_xns,xwater
  integer :: iter_max
!  !Option
!  integer :: cplx_wfld
...
!  endif
  ...
  !DENOISE IMAGE
  call sub_denoise_TV(n1,n2,n3,epsilon,delta,epsilon_noise,x_ns,x_dns,iter_max,xwater)
