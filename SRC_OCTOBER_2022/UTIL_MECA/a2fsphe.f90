...
!   input (ascii file)                                                          |
!                                                                               |
!       fsphe.asc  (sources)    10*4 = 40 bytes for each record                 |
...
open(10,file='fsphe.asc',status='unknown')
open(11,file='fsphe',access='direct',recl=10*4)
