...
integer(kind=4) :: ki_pos,ki_to,ki_m,ki_id,irec
...
open(11,file='fsrc.asc',status='unknown')
...
do irec=1,nsrc
  ...
  write(11,'(4f25.6,4i8)') sr_x,sr_y,sr_z,sr_to,ki_pos,ki_to,ki_m,ki_id
