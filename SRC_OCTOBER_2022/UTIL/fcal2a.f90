...
write(*,*) ' file conversion fcal into fcal.asc '
write(*,*) ' file fcal.flg for values -999. as flag of ray failure '

open(10,file='fcal',access='direct',recl=24)
open(11,file='fcal.asc',status='unknown')
open(12,file='fcal.flg',status='unknown')
...
do irec=1,nt ! lecture 
  ...
  if(abs(t_lu+999.) < 0.1) write(12,'(I8,2F25.15,3I8)') id_dat,t_lu,dt_lu,lut_src,lut_sta,lut_ray
enddo 
