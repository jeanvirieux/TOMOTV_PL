c
c        modif for the ZoneNumber ... negative value=take the opposite 
c
...
c-----Make sure the longitude is between -180.00 .. 179.9
      longt = (Long+180)/360
      LongTemp = (Long+180)-longt*360-180
c------180.00 .. 179.9
...
c
c   JEAN force la zone ... si valeur negative ... on l'impose
c

      if(ZoneNumber >= 0) then  ! negatif force la zone ...
         
         ZoneNumber = longt + 1
         
         if(Lat.ge.56.0.and.Lat.lt.64.0.and.
     +        LongTemp.ge.3.0.and.LongTemp.lt.12.0) ZoneNumber = 32
...
!      write(*,*) ' jean ',rad2deg*Long,Long
      Long = LongOrigin + Long*rad2deg

!      write(*,*) ' jean',LongOrigin,Long
      return
      end
